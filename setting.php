									...
									<div class="px-3">
										<form class="form" method="post" enctype="multipart/form-data">
											<div class="form-body row">
												...
												<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
													<div class="form-group">
														...
														<input type="text" id="cname" class="form-control" name="skey" value="<?php echo $getkey['sendgrid_key']; ?>">
													</div>
												</div>
												<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
													<div class="form-group">
														<label for="cname">Sendgrid API Linked Email</label>
														<input type="text" id="cname" class="form-control" name="smail" value="<?php echo $getkey['sendgrid_email']; ?>">
													</div>
												</div>
											...
											if (isset($_POST['sub_cat'])) {
												...
												$tax = $_POST['tax'];
												$con->query("update setting set one_key='" . $oid . "',one_hash='" . $ohash . "',sendgrid_key='" . $skey . "',sendgrid_email='" . $smail . "',r_key='" . $rid . "',favicon='" . $favicon . "',logo='" . $logo . "',title='" . $title . "',tax=" . $tax . ",r_hash='" . $rhash . "',currency='" . $currency . "',privacy_policy='" . $p_data . "',about_us='" . $a_data . "',contact_us='" . $c_data . "',terms='" . $terms . "',o_min=" . $omin . ",`timezone`='" . $timezone . "',maintaince=" . $maintaince . ",callsupport='" . $callsupport . "' where id=1");
